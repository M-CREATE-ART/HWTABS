...
public class Family {
    ...
    public String childToFile() {
        StringBuilder sb = new StringBuilder();
        children.forEach(child -> sb.append(child.humanToFile()).append(","));
        return sb.toString();
    }
    ...
    public String familyToFile() {
        return String.format("%s#%s#%s#%s", mother.humanToFile(), father.humanToFile(), childToFile(), petToFile() );
